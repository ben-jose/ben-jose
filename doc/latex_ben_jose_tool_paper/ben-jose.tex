...
\item
GMP Library for c++ development installed (\texttt{libgmp}, \texttt{libgmp-dev} and \texttt{libgmpxx}).
\end{itemize}
...
These commands are safe to be run even if they are already installed because it will just tell you so.
